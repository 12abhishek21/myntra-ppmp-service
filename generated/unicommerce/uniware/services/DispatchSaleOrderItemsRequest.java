...
@XmlRootElement(name = "DispatchSaleOrderItemsRequest")
public class DispatchSaleOrderItemsRequest {

    @XmlElement(name = "SaleOrderCode", required = true)
    protected String saleOrderCode;
    @XmlElement(name = "SaleOrderItemCodes")
    protected DispatchSaleOrderItemsRequest.SaleOrderItemCodes saleOrderItemCodes;
     ...
     * @return
     *     possible object is
     *     {@link DispatchSaleOrderItemsRequest.SaleOrderItemCodes }
     *     
     */
    public DispatchSaleOrderItemsRequest.SaleOrderItemCodes getSaleOrderItemCodes() {
     ...
     *     
     */
    public void setSaleOrderItemCodes(DispatchSaleOrderItemsRequest.SaleOrderItemCodes value) {
