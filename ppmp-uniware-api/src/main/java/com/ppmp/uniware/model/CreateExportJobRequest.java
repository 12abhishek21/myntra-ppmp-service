...
public class CreateExportJobRequest {
    ...
    protected ExportFilters exportFilters;
     ...
     *     
     */
    public ExportFilters getExportFilters() {
     ...
     *     
     */
    public void setExportFilters(ExportFilters value) {
    ...
    public static class ExportFilters {
        ...
        protected List<ExportFilter> exportFilter;
         ...
         * 
         */
        public List<ExportFilter> getExportFilter() {
            if (exportFilter == null) {
                exportFilter = new ArrayList<ExportFilter>();
            }
        ...
        public static class ExportFilter {
            ...
            protected SelectedValues selectedValues;
             ...
             *     
             */
            public void setSelectedValues(SelectedValues value) {
