...
public class CreateSaleOrderItemAlternateRequest {
    ...
    protected SaleOrderItemAlternates saleOrderItemAlternates;
     ...
     * @return
     *     possible object is
     *     {@link SaleOrderItemAlternates }
     *     
     */
    public SaleOrderItemAlternates getSaleOrderItemAlternates() {
     ...
     *     
     */
    public void setSaleOrderItemAlternates(SaleOrderItemAlternates value) {
    ...
    public static class SaleOrderItemAlternates {
        ...
        protected List<SaleOrderItemAlternate> saleOrderItemAlternate;
         ...
         * {@link SaleOrderItemAlternate }
         * 
         * 
         */
        public List<SaleOrderItemAlternate> getSaleOrderItemAlternate() {
            if (saleOrderItemAlternate == null) {
                saleOrderItemAlternate = new ArrayList<SaleOrderItemAlternate>();
            }
