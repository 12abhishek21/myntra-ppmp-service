...
public class GetTaxTypeConfigurationResponse {
    ...
    protected TaxTypeConfigurations taxTypeConfigurations;
     ...
     * @return
     *     possible object is
     *     {@link TaxTypeConfigurations }
     *     
     */
    public TaxTypeConfigurations getTaxTypeConfigurations() {
     ...
     *     
     */
    public void setTaxTypeConfigurations(TaxTypeConfigurations value) {
    ...
    public static class TaxTypeConfigurations {
        ...
        protected List<TaxTypeConfiguration> taxTypeConfiguration;
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link TaxTypeConfiguration }
         * 
         * 
         */
        public List<TaxTypeConfiguration> getTaxTypeConfiguration() {
            if (taxTypeConfiguration == null) {
                taxTypeConfiguration = new ArrayList<TaxTypeConfiguration>();
            }
