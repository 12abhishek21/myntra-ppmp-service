...
public class GetVendorItemTypesResponse {
    ...
    protected VendorItemTypes vendorItemTypes;
     ...
     * @return
     *     possible object is
     *     {@link VendorItemTypes }
     *     
     */
    public VendorItemTypes getVendorItemTypes() {
     ...
     *     
     */
    public void setVendorItemTypes(VendorItemTypes value) {
    ...
    public static class VendorItemTypes {
        ...
        protected List<VendorItemType> vendorItemType;
         ...
         * 
         */
        public List<VendorItemType> getVendorItemType() {
            if (vendorItemType == null) {
                vendorItemType = new ArrayList<VendorItemType>();
            }
