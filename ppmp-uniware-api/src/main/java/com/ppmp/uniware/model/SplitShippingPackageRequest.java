...
public class SplitShippingPackageRequest {
    ...
    protected SplitSaleOrderItems splitSaleOrderItems;
     ...
     * @return
     *     possible object is
     *     {@link SplitSaleOrderItems }
     *     
     */
    public SplitSaleOrderItems getSplitSaleOrderItems() {
     ...
     *     
     */
    public void setSplitSaleOrderItems(SplitSaleOrderItems value) {
    ...
    public static class SplitSaleOrderItems {
        ...
        protected List<SplitSaleOrderItem> splitSaleOrderItem;
         ...
         * {@link SplitSaleOrderItem }
         * 
         * 
         */
        public List<SplitSaleOrderItem> getSplitSaleOrderItem() {
            if (splitSaleOrderItem == null) {
                splitSaleOrderItem = new ArrayList<SplitSaleOrderItem>();
            }
